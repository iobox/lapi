  ...
  _createClass(Controller, [{
    ...
    value: function setRoute(route) {
      if (route instanceof _route2.default) {
        ...
        throw new _invalidArgument2.default('[http.Controller#setRoute] route must be an instance of Route');
      }
    }
    ...
    value: function setRequest(request) {
      if (request instanceof _request2.default) {
        ...
        throw new _invalidArgument2.default('[http.Controller#setRequest] request must be an instance of Request');
      }
    }
    ...
    value: function setResponse(response) {
      if (response instanceof _response2.default) {
        ...
        throw new _invalidArgument2.default('[http.Controller#setResponse] request must be an instance of Response');
      }
    }
